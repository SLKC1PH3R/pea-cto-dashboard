  ...
  return (
    <form onSubmit={handleSubmit} className="flex flex-col gap-3">
      ...
      <div className="grid grid-cols-3 gap-3">
        <div>
          <label className="mb-1 block text-sm text-[var(--fg2)]">Montant / exécution</label>
          <input
            type="number"
            step="any"
            required
        ...
        <div>
          <label className="mb-1 block text-sm text-[var(--fg2)]">Fréquence</label>
          <select
            value={frequency}
        ...
        <div>
          <label className="mb-1 block text-sm text-[var(--fg2)]">1ère exécution</label>
          <input
            type="date"
            required
